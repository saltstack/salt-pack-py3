...
{% set sls_name = "python-pyflakes" %}
{% set pypi_name = "pyflakes" %}
...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
      ...
      - salt://{{slspath}}/sources/pyflakes_1.6.0-1.debian.tar.xz
      - salt://{{slspath}}/sources/pyflakes-1.1.0-python3-man.patch
