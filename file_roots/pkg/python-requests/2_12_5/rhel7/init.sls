...
{{ macros.results(sls_name, pkg_data) }}
    ...
    - spec: salt://{{slspath}}/spec/python3-{{pypi_name}}.spec
    - template: jinja
...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
      - salt://{{slspath}}/sources/python-requests-remove-nested-bundling-dep.patch
      - salt://{{slspath}}/sources/python-requests-system-cert-bundle.patch
      - salt://{{slspath}}/sources/python-requests-urllib3-at-1.19.1.patch
      - salt://{{slspath}}/sources/requests-2.12.5.tar.gz
