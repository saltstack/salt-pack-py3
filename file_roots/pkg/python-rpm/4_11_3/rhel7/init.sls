...
{{ macros.requires(sls_name, pkg_data) }}
    ...
    - sources:
      ...
      - salt://{{slspath}}/sources/rpm-4.14.x-python-package-name.patch
      ...
      - salt://{{slspath}}/sources/rpm-4.11.3-brp-python-bytecompile-Fix-when-default-python-is-no.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-add-g-libs.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-correct-g-libs.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-dependson.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-disk-space-calculation.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-perl.req-6.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-remove-perl-provides-from-requires.patch
      - salt://{{slspath}}/sources/rpm-4.11.x-setcaps.patch
      - salt://{{slspath}}/sources/rpm-4.12.0-Fix-Python3-import.patch
      - salt://{{slspath}}/sources/rpm-4.13.x-bad-owner-group.patch
      - salt://{{slspath}}/sources/rpm-4.13.x-fix-segfault-on-fingerprint-symlink.patch
