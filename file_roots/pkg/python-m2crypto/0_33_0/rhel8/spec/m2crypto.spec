...
This package allows you to call OpenSSL functions from Python %{python3_version} scripts.
Supports Python 3.
%endif
...
%changelog
* Thu May 09 2019 SaltStack Packaging Team <packaging@saltstack.com> - 0.33.0-1
- Added support for Redhat 8, and support for Python 2 packages optional

* Tue Apr 09 2019 SaltStack Packaging Team <packaging@saltstack.com> - 0.31.0-3
- Adjusted support for Python 3.6 for Redhat 7
