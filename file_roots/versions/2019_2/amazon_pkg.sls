...
{% if buildcfg.build_release == 'amzn2' %}
    ...
    - pkg.distribution-gpg-keys.1_30.amzn2  ## B
    - pkg.libsodium.1_0_16.amzn2            ## B
    - pkg.libtomcrypt.1_17.amzn2            ## B    Need to check latest
    - pkg.libtommath.0_42_0.amzn2           ## B    Need to check latest
    - pkg.openpgm.5_2_122.amzn2             ## B    Need to check latest
    - pkg.mock.1_4_15.amzn2                 ## 
    - pkg.mock-core-configs.30_3.amzn2      ## B
